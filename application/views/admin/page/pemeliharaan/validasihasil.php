    ...
    <div class="content-wrapper">
      ...
      <!-- box header -->
        <div class="box-header with-border">
          <h3 class="box-title">Validasi Hasil Pemeliharaan</h3>
        ...
        <table class="table table-hover" id="contoh" width="100%">
          ...
          <tbody>
            ...
            WHERE hsl_pemeliharaan.keterangan IS NULL"; 
             ...
             <?php while ($data = mysqli_fetch_assoc($query)): ?>
              ...
              <td><?php echo $data['keterangan']; ?></td>
                  <td> <?php if ($_SESSION['level'] =='Administrasi' ): ?>
                    <a method="POST" href="konfirmasivalidasi.php?kd_hasil=<?php echo $data['kd_hasil']; ?>" class="btn btn-primary">Validasi</a>
