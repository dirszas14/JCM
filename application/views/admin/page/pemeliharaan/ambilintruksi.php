...
$sql= "SELECT kd_pemeliharaan FROM pemeliharaan WHERE kd_pemeliharaan='$kd_pemeliharaan'";
        ...
        <div class="box-body">
          ...
          <form class="form-horizontal" action="../../function/pemeliharaan-model.php" method='post'>
            ...
            <div class="col-sm-1 pull-right">
              ...
              <button type="submit" class="btn btn-primary" name="updatepemeliharaan">Ambil</button>
            </div>
